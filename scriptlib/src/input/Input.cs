...
namespace Aderite
{
    ...
    public class Input
    {
        ...
        {
            Vector3 mousePos = __GetMousePosition();
        ...
        {
            Vector3 mouseDelta = __GetMouseDelta();
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        private extern static Vector3 __GetMousePosition();

        [MethodImpl(MethodImplOptions.InternalCall)]
        private extern static Vector3 __GetMouseDelta();
