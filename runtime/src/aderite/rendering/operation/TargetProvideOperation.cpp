...
TargetProvideOperation::TargetProvideOperation(const TargetParams& params) : m_params(params) {}
...
void TargetProvideOperation::createFramebuffer() {
    ...
    const uint64_t textureFlags = (m_params.Blittable ? BGFX_TEXTURE_BLIT_DST : 0) | 0;
