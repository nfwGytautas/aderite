...
int main(int argc, char** argv) {
	if (aderite::engine::get()->init({})) {
		...
		auto handle = window.as<aderite::window_backend::glfw::glfw_window>()->get_handle();
		...
		// Custom loop to inject ImGui
		while (!window->closed) {
			window->begin_frame();

			// TODO: Move to dedicated layer
			// ImGui
