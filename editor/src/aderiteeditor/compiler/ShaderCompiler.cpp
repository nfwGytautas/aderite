...
ShaderCompiler::ShaderCompiler(const std::filesystem::path vertex, const std::filesystem::path fragment, const std::filesystem::path varying) 
	: m_vertex(vertex), m_fragment(fragment), m_varying(varying)
{}
