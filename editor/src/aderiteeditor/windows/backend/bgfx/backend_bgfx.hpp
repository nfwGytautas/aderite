...
// https://github.com/pr0g/sdl-bgfx-imgui-starter/blob/main/bgfx-imgui/imgui_impl_bgfx.h
...
// Use if you want to reset your rendering device without losing ImGui shared::State::.
